...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Marwan Sutyawan — Frontend Web Developer</title>
        <meta name="description" content="Website resmi Marwan Sutyawan, Front-End Web Developer. Saya berfokus pada penciptaan pengalaman digital yang menarik dan selalu berupaya memberikan solusi terbaik dalam setiap proyek yang saya kerjakan." />
     <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://wanzs.com" />
        <meta property="og:title" content="Marwan Sutyawan — Frontend Web Developer" />
     <meta property="og:description" content="Website resmi dan portofolio Marwan Sutyawan, Front-End Web Developer." />
        <meta property="og:url" content="https://wanzs.com" />
        <meta property="og:type" content="website" />
        <script type="application/ld+json">{`
          {
            "@context": "https://schema.org",
            "@type": "Person",
            "name": "Marwan Sutyawan",
